...
public class Constant {
	public static final String HIBERNATE_USERNAME="admin";
	...
	public static final String HIBERNATE_URL="jdbc:mysql://database-1.cnjixg3clbau.ap-southeast-1.rds.amazonaws.com:3306/library_login";
